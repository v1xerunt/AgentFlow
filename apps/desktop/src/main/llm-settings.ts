...
const AGENT_TOOLS: AgentToolPreset[] = [
  ...
  { id: 'agent-tool:kimi-code', name: 'Kimi Code', command: 'kimi', args: ['-p', '{prompt}', '--output-format', 'stream-json'], resumeArgs: ['-r', '{session}', '-p', '{prompt}', '--output-format', 'stream-json'], modelArgs: ['-m', '{model}'], loginCommand: 'kimi login' },
  { id: 'agent-tool:antigravity', name: 'Antigravity', command: 'agy', args: ['-p', '{prompt}', '--output-format', 'stream-json', '--sandbox'], resumeArgs: ['-p', '{prompt}', '--output-format', 'stream-json', '--sandbox', '--conversation', '{session}'], modelArgs: ['--model', '{model}'], reasoningArgs: ['--effort', '{reasoning}'], loginCommand: 'agy' }
]
