...
export const zhMessages = {
  ...
  "Could not start Claude login. Check the runtime and Git Bash, then try again.": "无法启动 Claude 登录，请检查运行时和 Git Bash 后重试。",
  ...
  "Sign in": "登录",
  "runtime": "运行时连接账户",
  "Initialization uses default settings. Claude can make mistakes; check its output and use it only in trusted projects.": "初始化采用默认设置。Claude 可能出错，请检查生成的内容；仅在可信项目中使用。",
